...
#define configUSE_TICK_HOOK		0   /*如果你在FreeRTOSConfig.h中设置了configUSE_TICK_HOOK=1，则必须编写voidvApplicationTickHook( void )函数。该函数利用时间片中断，可以很方便的实现一个定时器功能*/
#define configCPU_CLOCK_HZ		( ( unsigned long ) 72000000 )	/*CPU执行时的频率*/
#define configTICK_RATE_HZ		( ( portTickType ) 1000 )          /*FreeRTOS的时间片频率*/
/*5*/
